...
export class VendorService {
  searchVendors(query: string): Observable<Vendor[]> {
    return timer(1000).pipe(map(() => this.vendorsList.filter(x => x.name.includes(query))))
  }

  private vendorsList: Vendor[] = [
    { id: uuidv4(), name: 'John Doe', type: 'MANUFACTURER' },
    ...
    { id: uuidv4(), name: 'Roxie Silverhand', type: 'TRADESHOWREPRESENTATIVE' },
    ...
    { id: uuidv4(), name: 'Jenna Masters', type: 'MANUFACTURER' },
